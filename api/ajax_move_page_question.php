<?php
    ...
    $post = array('questionid' => end($newTargetQuestionIds), 'nextid' => $newTargetQuestionIds[count($newTargetQuestionIds) - 2], 'page_number' => $params['target_page_number'], 'mode' => 'd');
	
	// ページ情報を保存
	$moodles->setPageOrders($params['cmid'], $pages, $post);
